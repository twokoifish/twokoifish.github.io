...
export default {
  ...
  "variants": {
    ...
    "color": {
      ...
      "sky": {
        "trigger": "group-data-[state=completed]:bg-sky group-data-[state=active]:bg-sky focus-visible:outline-sky",
        "separator": "group-data-[state=completed]:bg-sky"
      },
      "amber": {
        "trigger": "group-data-[state=completed]:bg-amber group-data-[state=active]:bg-amber focus-visible:outline-amber",
        "separator": "group-data-[state=completed]:bg-amber"
      },
      "blue": {
        "trigger": "group-data-[state=completed]:bg-blue group-data-[state=active]:bg-blue focus-visible:outline-blue",
        "separator": "group-data-[state=completed]:bg-blue"
      },
      "stone": {
        "trigger": "group-data-[state=completed]:bg-stone group-data-[state=active]:bg-stone focus-visible:outline-stone",
        "separator": "group-data-[state=completed]:bg-stone"
      },
      "neutral": {
