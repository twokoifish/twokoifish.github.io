...
export default {
  ...
  "variants": {
    "color": {
      ...
      "tertiary": {
        ...
        "indicator": "bg-tertiary" as typeof indicator[number]
      },
      "info": {
      ...
      "sky": {
        "base": "focus-visible:outline-sky",
        "indicator": "bg-sky" as typeof indicator[number]
      },
      "amber": {
      ...
      "blue": {
        "base": "focus-visible:outline-blue",
        "indicator": "bg-blue" as typeof indicator[number]
      },
      "stone": {
        "base": "focus-visible:outline-stone",
        "indicator": "bg-stone" as typeof indicator[number]
      },
      "neutral": {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "card" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:border-sky"
      }
    },
    {
    ...
    },
    {
      ...
      "variant": "card" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:border-blue"
      }
    },
    {
      ...
      "variant": "card" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:border-stone"
      }
    },
    {
    ...
    },
    {
      ...
      "variant": "table" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:bg-sky/10 has-data-[state=checked]:border-sky/50 has-data-[state=checked]:z-[1]"
      }
    },
    {
      "color": "amber" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "table" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:bg-blue/10 has-data-[state=checked]:border-blue/50 has-data-[state=checked]:z-[1]"
      }
    },
    {
      "color": "stone" as typeof color[number],
      "variant": "table" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:bg-stone/10 has-data-[state=checked]:border-stone/50 has-data-[state=checked]:z-[1]"
      }
    },
    {
      "color": "neutral" as typeof color[number],
