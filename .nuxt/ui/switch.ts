...
export default {
  ...
  "variants": {
    "color": {
      ...
      "sky": {
        "base": "data-[state=checked]:bg-sky focus-visible:outline-sky",
        "icon": "group-data-[state=checked]:text-sky"
      },
      "amber": {
        "base": "data-[state=checked]:bg-amber focus-visible:outline-amber",
        "icon": "group-data-[state=checked]:text-amber"
      },
      "blue": {
        "base": "data-[state=checked]:bg-blue focus-visible:outline-blue",
        "icon": "group-data-[state=checked]:text-blue"
      },
      "stone": {
        "base": "data-[state=checked]:bg-stone focus-visible:outline-stone",
        "icon": "group-data-[state=checked]:text-stone"
      },
      "neutral": {
