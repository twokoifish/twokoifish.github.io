...
export default {
  ...
  "variants": {
    "color": {
      ...
      "tertiary": {
        "range": "bg-tertiary",
        "thumb": "ring-tertiary focus-visible:outline-tertiary/50"
      },
      "info": {
        "range": "bg-info",
      ...
      "sky": {
        "range": "bg-sky",
        "thumb": "ring-sky focus-visible:outline-sky/50"
      },
      "amber": {
        "range": "bg-amber",
      ...
      "blue": {
        "range": "bg-blue",
        "thumb": "ring-blue focus-visible:outline-blue/50"
      },
      "stone": {
        "range": "bg-stone",
        "thumb": "ring-stone focus-visible:outline-stone/50"
      },
      "neutral": {
        "range": "bg-inverted",
