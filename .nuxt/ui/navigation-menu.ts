...
export default {
  ...
  "variants": {
    "color": {
      ...
      "sky": {
        ...
        "childLink": "focus-visible:before:ring-sky"
      },
      "amber": {
      ...
      "blue": {
        ...
        "childLink": "focus-visible:before:ring-blue"
      },
      "stone": {
        "link": "focus-visible:before:ring-stone",
        "childLink": "focus-visible:before:ring-stone"
      },
      "neutral": {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "class": {
        "link": "text-sky",
        "linkLeadingIcon": "text-sky group-data-[state=open]:text-sky"
      }
    },
    {
    ...
    },
    {
      ...
      "class": {
        "link": "text-blue",
        "linkLeadingIcon": "text-blue group-data-[state=open]:text-blue"
      }
    },
    {
      ...
      "class": {
        "link": "text-stone",
        "linkLeadingIcon": "text-stone group-data-[state=open]:text-stone"
      }
    },
    {
    ...
    {
      "highlightColor": "tertiary" as typeof highlightColor[number],
      "highlight": true,
      "level": true,
      "active": true,
      "class": {
    ...
    {
      "highlightColor": "sky" as typeof highlightColor[number],
      "highlight": true,
      "level": true,
      "active": true,
      "class": {
    ...
    {
      "highlightColor": "blue" as typeof highlightColor[number],
      "highlight": true,
      "level": true,
      "active": true,
      "class": {
    ...
    {
      "highlightColor": "stone" as typeof highlightColor[number],
      "highlight": true,
      "level": true,
      "active": true,
      "class": {
