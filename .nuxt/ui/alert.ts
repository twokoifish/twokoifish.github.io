...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "solid" as typeof variant[number],
      "class": {
        "root": "bg-tertiary text-inverted"
      }
    },
    {
    ...
    },
    {
      ...
      "variant": "outline" as typeof variant[number],
      "class": {
        "root": "text-sky ring ring-inset ring-sky/25"
      }
    },
    {
      "color": "amber" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "outline" as typeof variant[number],
      "class": {
        "root": "text-blue ring ring-inset ring-blue/25"
      }
    },
    {
      "color": "stone" as typeof color[number],
      "variant": "outline" as typeof variant[number],
      "class": {
        "root": "text-stone ring ring-inset ring-stone/25"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "subtle" as typeof variant[number],
      "class": {
        "root": "bg-sky/10 text-sky ring ring-inset ring-sky/25"
      }
    },
    {
      "color": "amber" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "subtle" as typeof variant[number],
      "class": {
        "root": "bg-blue/10 text-blue ring ring-inset ring-blue/25"
      }
    },
    {
      "color": "stone" as typeof color[number],
      "variant": "subtle" as typeof variant[number],
      "class": {
        "root": "bg-stone/10 text-stone ring ring-inset ring-stone/25"
      }
    },
    {
