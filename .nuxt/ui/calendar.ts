  ...
  "variants": {
    "color": {
      ...
      "tertiary": {
        ...
        "cellTrigger": "focus-visible:ring-tertiary data-[selected]:bg-tertiary data-today:not-data-[selected]:text-tertiary data-[highlighted]:bg-tertiary/20 hover:not-data-[selected]:bg-tertiary/20"
      },
      "info": {
        "headCell": "text-info",
      ...
      "sky": {
        "headCell": "text-sky",
        "cellTrigger": "focus-visible:ring-sky data-[selected]:bg-sky data-today:not-data-[selected]:text-sky data-[highlighted]:bg-sky/20 hover:not-data-[selected]:bg-sky/20"
      },
      "amber": {
        "headCell": "text-amber",
        "cellTrigger": "focus-visible:ring-amber data-[selected]:bg-amber data-today:not-data-[selected]:text-amber data-[highlighted]:bg-amber/20 hover:not-data-[selected]:bg-amber/20"
      },
      "blue": {
        "headCell": "text-blue",
        "cellTrigger": "focus-visible:ring-blue data-[selected]:bg-blue data-today:not-data-[selected]:text-blue data-[highlighted]:bg-blue/20 hover:not-data-[selected]:bg-blue/20"
      },
      "stone": {
        "headCell": "text-stone",
        "cellTrigger": "focus-visible:ring-stone data-[selected]:bg-stone data-today:not-data-[selected]:text-stone data-[highlighted]:bg-stone/20 hover:not-data-[selected]:bg-stone/20"
      },
      "neutral": {
