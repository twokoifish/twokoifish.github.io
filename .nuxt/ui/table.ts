...
export default {
  ...
  "compoundVariants": [
    ...
    {
      "loading": true,
      "loadingColor": "tertiary" as typeof loadingColor[number],
      "class": {
        "thead": "after:bg-tertiary"
      }
    },
    {
      "loading": true,
    ...
    {
      "loading": true,
      "loadingColor": "sky" as typeof loadingColor[number],
      "class": {
        "thead": "after:bg-sky"
      }
    },
    ...
    {
      "loading": true,
      "loadingColor": "blue" as typeof loadingColor[number],
      "class": {
        "thead": "after:bg-blue"
      }
    },
    {
      "loading": true,
      "loadingColor": "stone" as typeof loadingColor[number],
      "class": {
        "thead": "after:bg-stone"
      }
    },
    {
      "loading": true,
