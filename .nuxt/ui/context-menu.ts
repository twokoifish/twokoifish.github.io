...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "active": false,
      "class": {
        "item": "text-tertiary data-highlighted:text-tertiary data-highlighted:before:bg-tertiary/10 data-[state=open]:before:bg-tertiary/10",
        "itemLeadingIcon": "text-tertiary/75 group-data-highlighted:text-tertiary group-data-[state=open]:text-tertiary"
      }
    },
    {
    ...
    },
    {
      ...
      "active": false,
      "class": {
        "item": "text-sky data-highlighted:text-sky data-highlighted:before:bg-sky/10 data-[state=open]:before:bg-sky/10",
        "itemLeadingIcon": "text-sky/75 group-data-highlighted:text-sky group-data-[state=open]:text-sky"
      }
    },
    {
    ...
    },
    {
      ...
      "active": false,
      "class": {
        "item": "text-blue data-highlighted:text-blue data-highlighted:before:bg-blue/10 data-[state=open]:before:bg-blue/10",
        "itemLeadingIcon": "text-blue/75 group-data-highlighted:text-blue group-data-[state=open]:text-blue"
      }
    },
    {
      ...
      "active": false,
      "class": {
        "item": "text-stone data-highlighted:text-stone data-highlighted:before:bg-stone/10 data-[state=open]:before:bg-stone/10",
        "itemLeadingIcon": "text-stone/75 group-data-highlighted:text-stone group-data-[state=open]:text-stone"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "active": true,
      "class": {
        "item": "text-tertiary before:bg-tertiary/10",
        "itemLeadingIcon": "text-tertiary"
      }
    },
    {
      "color": "info" as typeof color[number],
    ...
    },
    {
      ...
      "active": true,
      "class": {
        "item": "text-sky before:bg-sky/10",
        "itemLeadingIcon": "text-sky"
      }
    },
    {
      "color": "amber" as typeof color[number],
    ...
    },
    {
      ...
      "active": true,
      "class": {
        "item": "text-blue before:bg-blue/10",
        "itemLeadingIcon": "text-blue"
      }
    },
    {
      "color": "stone" as typeof color[number],
      "active": true,
      "class": {
        "item": "text-stone before:bg-stone/10",
        "itemLeadingIcon": "text-stone"
      }
    }
  ],
  "defaultVariants": {
